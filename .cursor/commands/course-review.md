...
| D | `reference/delivery-review.md` §Gate 2b、`reference/chapter-practice-dom.md`、`example/.../demos/` | 各 lab：**执行** README 验收命令（能跑则跑）；文档型 lab 按 checklist 抽检 |
...
见 skill `reference/delivery-review.md`（返工上限）、`workflows.md`（禁止手改 `index.html` 等）。
