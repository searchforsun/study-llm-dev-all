# Demo：Spring AI 客服 Agent

对应章节：[Spring AI 客服 Agent](../../index.html#ch-practice-03-agent-dual)
...
### Windows PowerShell
```powershell
cd courses/scenario-java-customer-service/demos/practice-03-agent-dual-lab
...
[降级与人工转接](../../index.html#ch-practice-04-handoff) · Demo：[降级与人工转接](../practice-04-handoff-lab/)
