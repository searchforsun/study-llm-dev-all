...
对应章节：[客服效果评测](../../index.html#ch-practice-05-eval)
...
### Windows PowerShell
```powershell
cd courses/scenario-java-customer-service/demos/practice-05-eval-lab
...
[生产坑：DST、确定性与高并发](../../index.html#ch-practice-06-production-pitfalls) · Demo：[生产坑：DST、确定性与高并发](../practice-06-production-pitfalls-lab/)
