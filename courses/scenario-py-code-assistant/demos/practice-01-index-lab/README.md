...
对应章节：[代码索引流水线（Python）](../../index.html#ch-practice-01-index)
...
### Windows PowerShell
```powershell
cd courses/scenario-py-code-assistant/demos/practice-01-index-lab
uv venv
...
[仓库问答 API（Python）](../../index.html#ch-practice-02-qa-api) · Demo：[仓库问答 API（Python）](../practice-02-qa-api-lab/)
