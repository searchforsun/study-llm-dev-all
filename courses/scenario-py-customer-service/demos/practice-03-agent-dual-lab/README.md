# Demo：LangGraph 客服 Agent

对应章节：[LangGraph 客服 Agent](../../index.html#ch-practice-03-agent-dual)
...
### Windows PowerShell
```powershell
cd courses/scenario-py-customer-service/demos/practice-03-agent-dual-lab
uv venv
