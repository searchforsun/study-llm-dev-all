...
### Windows PowerShell
```powershell
cd courses/scenario-java-content-studio/demos/practice-04-eval-lab
...
[双栈创作 API 联调](../../index.html#ch-practice-05-dual-stack) · Demo：[双栈创作 API 联调](../practice-05-dual-stack-lab/)
