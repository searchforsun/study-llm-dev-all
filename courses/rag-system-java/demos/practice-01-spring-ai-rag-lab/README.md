# Demo：Spring AI RAG Pipeline

对应章节：[Spring AI RAG Pipeline](../../index.html#ch-practice-01-spring-ai-rag)
...
### Windows PowerShell
```powershell
cd courses/rag-system-java/demos/practice-01-spring-ai-rag-lab
...
[VectorStore 实战](../../index.html#ch-practice-02-vectorstore-practice) · Demo：[VectorStore 实战](../practice-02-vectorstore-practice-lab/)
