...
### Windows PowerShell
```powershell
cd courses/scenario-java-agent-automation/demos/practice-05-demo-lab
...
[生产坑：规划、工具与记忆](../../index.html#ch-practice-06-production-pitfalls) · Demo：[生产坑：规划、工具与记忆](../practice-06-production-pitfalls-lab/)
