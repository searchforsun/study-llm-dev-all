...
### Windows PowerShell
```powershell
cd courses/scenario-java-agent-automation/demos/practice-03-multi-tool-lab
...
[多 Agent 协作](../../index.html#ch-practice-04-multi-agent) · Demo：[多 Agent 协作](../practice-04-multi-agent-lab/)
