...
### Windows PowerShell
```powershell
cd courses/scenario-java-agent-automation/demos/practice-04-multi-agent-lab
...
[完整 Agent 演示链路](../../index.html#ch-practice-05-demo) · Demo：[完整 Agent 演示链路](../practice-05-demo-lab/)
