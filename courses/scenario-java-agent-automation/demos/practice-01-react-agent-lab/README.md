# Demo：ReactAgent 工作流实现（Java）

对应章节：[ReactAgent 工作流实现（Java）](../../index.html#ch-practice-01-react-agent)
...
### Windows PowerShell
```powershell
cd courses/scenario-java-agent-automation/demos/practice-01-react-agent-lab
...
[Spring AI Alibaba Graph](../../index.html#ch-practice-02-saa-graph) · Demo：[Spring AI Alibaba Graph](../practice-02-saa-graph-lab/)
