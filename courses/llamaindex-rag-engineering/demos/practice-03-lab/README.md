...
对应章节：[评测与迭代](../../index.html#ch-practice-03)
...
### Windows PowerShell
```powershell
cd courses/llamaindex-rag-engineering/demos/practice-03-lab
uv venv
...
[多知识库与路由](../../index.html#ch-practice-04) · Demo：[多知识库与路由](../practice-04-lab/)
