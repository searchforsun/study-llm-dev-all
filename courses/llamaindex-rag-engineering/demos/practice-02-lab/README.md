...
对应章节：[Agent + Tools 集成](../../index.html#ch-practice-02)
...
### Windows PowerShell
```powershell
cd courses/llamaindex-rag-engineering/demos/practice-02-lab
uv venv
...
[评测与迭代](../../index.html#ch-practice-03) · Demo：[评测与迭代](../practice-03-lab/)
