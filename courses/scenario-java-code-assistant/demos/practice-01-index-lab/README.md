...
对应章节：[代码索引流水线（Java）](../../index.html#ch-practice-01-index)
...
### Windows PowerShell
```powershell
cd courses/scenario-java-code-assistant/demos/practice-01-index-lab
...
[仓库问答 API（Java）](../../index.html#ch-practice-02-qa-api) · Demo：[仓库问答 API（Java）](../practice-02-qa-api-lab/)
