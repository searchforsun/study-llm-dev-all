# Demo：A2A 与 Nacos 分布式 Agent

对应章节：[A2A 与 Nacos 分布式 Agent](../../index.html#ch-practice-04)
...
### Windows PowerShell
```powershell
cd courses/agent-orchestration-java/demos/practice-04-lab
...
[实战：CorpAssist 办公 Agent](../../index.html#ch-practice-05) · Demo：[实战：CorpAssist 办公 Agent](../practice-05-lab/)
