...
对应章节：[MCP 协议集成](../../index.html#ch-practice-03)
...
### Windows PowerShell
```powershell
cd courses/agent-orchestration-java/demos/practice-03-lab
...
[A2A 与 Nacos 分布式 Agent](../../index.html#ch-practice-04) · Demo：[A2A 与 Nacos 分布式 Agent](../practice-04-lab/)
