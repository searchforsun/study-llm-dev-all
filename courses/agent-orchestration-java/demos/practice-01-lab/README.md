...
对应章节：[多 Agent 编排模式](../../index.html#ch-practice-01)
...
### Windows PowerShell
```powershell
cd courses/agent-orchestration-java/demos/practice-01-lab
...
[人在回路与审批](../../index.html#ch-practice-02) · Demo：[人在回路与审批](../practice-02-lab/)
